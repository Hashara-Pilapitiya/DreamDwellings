    ...
    try{
        ...
        if(user.favResidenciesID.includes((rid))){
           const updatedUser = await prisma.user.update({
            ...
            res.send({message: "Residency removed from favourites successfully", user: updatedUser});
        }else{
            const updatedUser = await prisma.user.update({
                where: {email: email},
                data: {
            ...
            res.send({message: "Residency added to favourites successfully", user: updatedUser});
        }
